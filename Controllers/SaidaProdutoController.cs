...
namespace ProjetoFinal.Controllers
{
    public class SaidaProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoId,DataSaidaProduto,QuantidadeSaida,UsuarioId,ClienteId,TipoSaidaId")] SaidaProduto saidaProduto)
        {
            if (ModelState.IsValid)
            {
                var produto = await _context.Produto.Where(p => p.Id == saidaProduto.ProdutoId).FirstOrDefaultAsync();
                produto.QunatidadeEstoque = produto.QunatidadeEstoque - saidaProduto.QuantidadeSaida;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProdutoId,DataSaidaProduto,QuantidadeSaida,UsuarioId,ClienteId,TipoSaidaId")] SaidaProduto saidaProduto)
        {

...
namespace ProjetoFinal.Controllers
{
    public class EntradaProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoId,DataEntradaProduto,QuantidadeEntrada")] EntradaProduto entradaProduto)
        {
            if (ModelState.IsValid)
            {
                var produto = await _context.Produto.Where(p => p.Id == entradaProduto.ProdutoId).FirstOrDefaultAsync();
                produto.QunatidadeEstoque = produto.QunatidadeEstoque + entradaProduto.QuantidadeEntrada;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProdutoId,DataEntradaProduto,QuantidadeEntrada")] EntradaProduto entradaProduto)
        {
